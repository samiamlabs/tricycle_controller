...
// TEST CASES
TEST_F(TricycleControllerTest, testForward)
{
  // wait for ROS
  waitForController();
...
TEST_F(TricycleControllerTest, testTurn)
{
  // wait for ROS
  waitForController();
...
TEST_F(TricycleControllerTest, testOdomFrame)
{
  // wait for ROS
  waitForController();
  // set up tf listener
...
int main(int argc, char** argv)
{
  ...
  ros::init(argc, argv, "tricycle_controller_twist_cmd_test");
